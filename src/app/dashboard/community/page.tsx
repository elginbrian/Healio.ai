...
const Community = () => {
    ...
    const publicQuestions = [
        {
            ...
            answer: {
                ...
                excerpt: 'Nyeri kepala yang berlangsung 3 hari sebaiknya tidak diabaikan. Untuk sementara, Anda bisa mengonsumsi paracetamol sesuai dosis. Namun, saya sarankan untuk segera konsultasi ke dokter jika nyeri tidak berkurang dalam 24 jam ke depan...',
        ...
        },
        {
            ...
            answer: {
                ...
                fullAnswer: 'Untuk balita usia 2 tahun, demam di atas 38°C yang berlangsung lebih dari 2 hari perlu evaluasi dokter. Beberapa tanda yang mengharuskan segera ke dokter: 1) Demam di atas 39°C, 2) Anak tampak sangat lemas atau sulit dibangunkan, 3) Sesak napas atau napas cepat, 4) Muntah terus menerus, 5) Tidak mau minum sama sekali, 6) Ruam di kulit, 7) Kejang. Meskipun anak masih mau makan minum, mengingat demam sudah 2 hari, saya sarankan untuk membawa ke dokter anak untuk pemeriksaan fisik dan menentukan penyebab demam, apakah infeksi virus atau bakteri yang memerlukan pengobatan khusus.'
            }
        },
        {
            id: '5',
            ...
            fullQuestion: 'Beberapa minggu ini saya susah sekali tidur. Meskipun sudah mengantuk, tapi begitu berbaring mata jadi melek lagi. Kalau sudah tertidur juga sering terbangun tengah malam dan susah tidur lagi. Ini mempengaruhi aktivitas saya di siang hari jadi sering ngantuk. Ada saran tidak?',
            answer: null
        },
        {
            id: '6',
            ...
            fullQuestion: 'Hasil lab saya menunjukkan kolesterol total 250 mg/dL, LDL 180 mg/dL. Dokter bilang harus diet ketat untuk menurunkan kolesterol. Saya bingung makanan apa saja yang boleh dan tidak boleh dikonsumsi. Bisa tolong dijelaskan?',
            answer: {
        ...
        },
        {
            ...
            fullQuestion: 'Sejak WFH, saya sering mengalami nyeri punggung bawah. Terutama setelah duduk lama di depan laptop. Kursi kerja saya juga tidak terlalu ergonomis. Ada tips untuk mengurangi nyeri dan mencegah agar tidak bertambah parah?',
            answer: null
        },
        {
            id: '8',
            ...
            fullQuestion: 'Anak saya usia 2 tahun masih belum bisa bicara dengan jelas. Hanya bisa beberapa kata sederhana seperti mama, papa, mam (makan). Teman-teman seusianya sudah bisa bicara 2-3 kata dalam satu kalimat. Apakah ini normal atau perlu terapi wicara?',
            answer: {
    ...
    const filteredQuestions = selectedCategory === 'Semua'
        ? publicQuestions
        : publicQuestions.filter(q => q.category === selectedCategory);
                ...
                {activeTab === 'public' && (
                    <div className='space-y-6'>
                        {filteredQuestions.length > 0 ? (
                            ...
                            <p className='text-gray-500 text-center py-12'>Tidak ada pertanyaan di kategori ini.</p>
                        )}
                    </div>
                )}

...
const testimonies = [
  {
    quote: 'Platform microfunding Healio.ai memungkinkan komunitas kami menggalang dana untuk operasi tetangga dengan sangat efisien. Dashboard real-time dan laporan transparansi membuat semua anggota merasa percaya diri dengan pengelolaan dana.',
  ...
  return (
    <div className="w-full pb-48 px-4 md:px-72">
      ...
      <div className={`transition-opacity duration-300 ease-in-out ${transitioning ? 'opacity-0' : 'opacity-100'}`}>
        <TestimonyCard
          quote={testimonies[index].quote}
          authorName={testimonies[index].authorName}
          authorTitle={testimonies[index].authorTitle}
          imageSrc={testimonies[index].imageSrc}
        />
      </div>
      ...
      <div className="flex justify-center mt-8 gap-4">
        <button
          onClick={handlePrev}
          className="p-3 bg-[var(--color-p-300)] rounded-full hover:bg-[var(--color-p-400)] transition"
        >
